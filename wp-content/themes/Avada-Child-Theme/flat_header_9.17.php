<?php
/**
 * Template Name: Flat Header Sept 2017
 * A template with a flat header instead of diagonal. The only difference between this template and the other Flat Header template is on line 18:  slanted-header2 instead of slanted-header.
 */
...
<div id="content" class="flat_header_template full-width" <?php Avada()->layout->add_style( 'content_style' ); ?>>
	<div class="flat_header slanted-header2"></div>
