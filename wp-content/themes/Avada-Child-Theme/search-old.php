...
?>
<?php get_header(); ?>
<div id="content" class="post-content" <?php Avada()->layout->add_class( 'content_class' ); ?> <?php Avada()->layout->add_style( 'content_style' ); ?>>
	...
	<?php if ( have_posts() && 0 != strlen( trim( get_search_query() ) ) ) : ?>
		...
		<?php if ( 'hidden' != Avada()->settings->get( 'search_new_search_position' ) ) : ?>
			<div class="search-page-search-form search-page-search-form-<?php echo Avada()->settings->get( 'search_new_search_position' ); ?> interior_header">
				<?php
				/**
				 * Render the post title
				 */
				echo avada_render_post_title( 0, false, esc_html__( 'Need a new search?', 'Avada' ), '1' );

				?>
				<p><?php //esc_html_e( 'If you didn\'t find what you were looking for, try a new search!', 'Avada' ); 
				echo avada_render_post_title( 0, false, esc_html__( 'If you didn\'t find what you were looking for, try a new search!', 'Avada' ), '3' );?></p>
	...
	<?php else : ?>
		...
		<div class="post-content">
			...
			<?php 
				...
				//echo Avada()->template->title_template( esc_html__( 'Couldn\'t find what you\'re looking for!', 'Avada' ) ); 
			?>
