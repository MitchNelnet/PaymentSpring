<?php
/**
 * Template Name: Flat Header RED - Sept 2017
 * A template with a flat header instead of diagonal. The only difference between this template and the other Flat Header template is on line 18:  slanted-header-red instead of slanted-header.  Use this template for RED / #f15d3f header pages with text under the headline.
 */
...
<div id="content" class="flat_header_template full-width" <?php Avada()->layout->add_style( 'content_style' ); ?>>
	<div class="flat_header slanted-header-red"></div>
