...
<head>
  <?php if (!is_user_logged_in()) { ?>
    ...
    <?php
    if (home_url() == 'https://paymentspring.com') { ?>
      <!-- Google Tag Manager PROD -->
      <script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
            new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],
          j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=
          'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
        })(window,document,'script','dataLayer','GTM-WSMR9DD');</script>
    ...
    <?php } else { ?>
      ...
      <script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
          ...
          j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=
          'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
        })(window,document,'script','dataLayer','GTM-T9M2HWP');</script>
...
n.push=n;n.loaded=!0;n.version='1.0';n.queue=[];t=a.createElement(e);t.async=0;t.src=v;z=a.getElementsByTagName(e)[0];z.parentNode.insertBefore(t,z)}(window,document,'script','https://tags.srv.stackadapt.com/events.js');saq('ts', '4aigcwfZ6MBYG_ndl-A_Qg');</script>
	...
	<?php
	//don't let search engines index any post that is not a blog.
	//this will prevent Support and Dev Docs posts from showing in search results, since they aren't styled and should only show in their main pages.
	if (is_single() && !has_category('blog', $c_page_id)) {
	...
	$desktop_bgimage_array = array();
	$mobile_bgimage_array = array();
	if (strlen(get_post_meta( $post->ID, 'meta-box-position-bgimage-desktop', true )) > 0) {
  	$desktop_bgimage_array = explode(";", get_post_meta( $post->ID, 'meta-box-position-bgimage-desktop', true ));
	}

	if (strlen(get_post_meta( $post->ID, 'meta-box-position-bgimage-mobile', true )) > 0) {
  	$mobile_bgimage_array = explode(";", get_post_meta( $post->ID, 'meta-box-position-bgimage-mobile', true ));
	}

	if (count($desktop_bgimage_array) > 0 || count($mobile_bgimage_array) > 0) {
		echo "<style>";

		if (count($desktop_bgimage_array) > 0) {
			echo ".uniform .flat_header.slanted-header:before {";
			if (strlen(sanitize_text_field($desktop_bgimage_array[0])) > 0) {
				echo "background-position: " . $desktop_bgimage_array[0] . " !important;";
			}
			if (strlen(sanitize_text_field($desktop_bgimage_array[1])) > 0) {
				echo "background-size: " . $desktop_bgimage_array[1] . " !important;";
			}
			echo "}";
		}

		if (count($mobile_bgimage_array) > 0) {
			echo "@media (max-width: 800px) {.uniform .flat_header.slanted-header:before {";
			if (strlen(sanitize_text_field($mobile_bgimage_array[0])) > 0) {
				echo "background-position: " . $mobile_bgimage_array[0] . " !important;";
			}
			if (strlen(sanitize_text_field($mobile_bgimage_array[1])) > 0) {
				echo "background-size: " . $mobile_bgimage_array[1] . " !important;";
			}
			echo "}}";
		}
...
<?php if (!is_user_logged_in()) { ?>
  ...
  <?php
  if (home_url() == 'https://factsmgt.com') { ?>
    <!-- Google Tag Manager (noscript) PROD -->
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WSMR9DD"
                      height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
    <!-- End Google Tag Manager (noscript) PROD -->
  <?php } else { ?>
    <!-- Google Tag Manager (noscript) DEV -->
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-T9M2HWP"
                      height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
