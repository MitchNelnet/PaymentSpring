<?php
/**
 * Template Name: Uniform Flat Header Template for a normal page
...
<div id="content" class="uniform flat_header_template full-width" <?php Avada()->layout->add_style( 'content_style' ); ?>>
