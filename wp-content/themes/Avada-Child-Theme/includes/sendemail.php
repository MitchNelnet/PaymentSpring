...
$unsubscribe = esc_html( $_GET['unsubscribe'] );
...
if (strlen($unsubscribe) < 1) {
	...
	$button_clicked = esc_html( $_GET['button_clicked'] );
	$user_email = esc_html( $_GET['unsubscribe'] );
	if ($button_clicked == NULL) {
		...
		<strong style='font-family:ProximaNovaA-Semibold;'>We're sorry to see you go! Are you sure you'd like to unsubscribe?</strong>
		<br /><br />
		<a style='background-color:#4fc0b0; padding:13px 29px; color: #fff; text-decoration: none; border-color: #fff; border-radius: 6px;' href='https://paymentspring.com/wp-content/themes/Avada-Child-Theme/includes/sendemail.php?unsubscribe=$user_email&button_clicked=2'>On second thought, keep me on your list.</a>
		<br /><br />
		<a style='background-color:#f15d3f; padding:13px 29px; color: #fff; text-decoration: none; border-color: #fff; border-radius: 6px;' href='https://paymentspring.com/wp-content/themes/Avada-Child-Theme/includes/sendemail.php?unsubscribe=$user_email&button_clicked=1'>Yes, I'm sure.</a>
		</body>";
		...
		<br /><br />
		<div style='font-size: 20px; background-color: #ffffff; padding: 50px; max-width: 660px; width: auto; margin-left: auto; margin-right: auto; margin-top: 50px; line-height: 30px;' >
		<strong style='font-family:ProximaNovaA-Semibold;'>" . $unsubscribe . "</strong>
		<br /><br />
		Thanks for staying on our list!
		</body>";
	}
	echo $output;
}
