<?php
/**
 * Template Name: Flat Header GREEN mod - Sept 2017
 * A template with a flat header instead of diagonal. The only difference between this template and the other Flat Header template is on line 18:  slanted-header-green-mod instead of slanted-header. Use this template for GREEN header pages with text under the headline.
 */
...
<div id="content" class="flat_header_template full-width" <?php Avada()->layout->add_style( 'content_style' ); ?>>
	<div class="flat_header slanted-header-green-mod"></div>
