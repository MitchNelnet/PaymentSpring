...
<div id="content" class="full-width">
	<div id="post-404page">
		<div class="post-content">
			...
			//$subtitle = esc_html__( '¯\_(ツ)_/¯ This Page Could Not Be Found!', 'Avada' );
			//echo Avada()->template->title_template( $subtitle );
			//echo "<div class='interior_header'><h1 style='position:relative'>" . $subtitle  . "</h1></div>"
			?>
			...
			<div class="error-page">
				<div class="fusion-columns fusion-columns-3">
					...
					<div class="fusion-column col-lg-4 col-md-4 col-sm-4">
						...
						<p><?php esc_html_e( 'You don\'t give up easily. We like that.', 'Avada' ); ?></p>
